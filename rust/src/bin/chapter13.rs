...
fn main() {
    ...
    let cylinder_1 = world.scene.insert_object(
        Shape::Cylinder {
            minimum: 0.0,
            maximum: 0.2,
            closed: true,
    ...
    let cylinder_2 = world.scene.insert_object(
        Shape::Cylinder {
            minimum: 0.0,
            maximum: 0.6,
            closed: true,
    ...
    let cylinder_3 = world.scene.insert_object(
        Shape::Cylinder {
            minimum: -1.0,
            maximum: 0.4,
            closed: false,
    ...
    let cylinder_4 = world.scene.insert_object(
        Shape::Cylinder {
            minimum: -1.0,
            maximum: 0.5,
            closed: true,
    ...
    let red_cylinder = world.scene.insert_object(
        Shape::Cylinder {
            minimum: -1.0,
            maximum: 1.0,
            closed: false,
    ...
    let red_cone = world.scene.insert_object(
        Shape::Cone {
            minimum: -1.0,
            maximum: 1.0,
            closed: false,
    ...
    let blue_cone = world.scene.insert_object(
        Shape::Cone {
            minimum: -1.0,
            maximum: 1.0,
            closed: true,
    ...
    let blue_glass_cylinder = world.scene.insert_object(
        Shape::Cylinder {
            minimum: -1.1,
            maximum: 0.7,
            closed: true,
    ...
    let green_glass_cylinder = world.scene.insert_object(
        Shape::Cylinder {
            minimum: -1.0,
            maximum: 1.0,
            closed: false,
    ...
    let background_1 = world.scene.insert_group(vec![cylinder_3, cylinder_4], None);

    let background_2 = world.scene.insert_group(vec![cylinder_1, cylinder_2], None);

    let foreground = world.scene.insert_group(
        vec![
            red_cylinder,
            red_cone,
            blue_cone,
    ...
    let root = world
        .scene
        .insert_group(vec![planes, background_1, background_2, foreground], None);
