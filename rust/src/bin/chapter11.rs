...
fn main() {
    ...
    let ball_1 = world.scene.insert_object(
        Shape::Sphere,
        Some(transform(&[
            scaling(0.4, 0.4, 0.4),
    ...
    let ball_2 = world.scene.insert_object(
        Shape::Sphere,
        Some(transform(&[
            scaling(0.3, 0.3, 0.3),
    ...
    let ball_3 = world.scene.insert_object(
        Shape::Sphere,
        Some(transform(&[
            scaling(0.5, 0.5, 0.5),
    ...
    let ball_4 = world.scene.insert_object(
        Shape::Sphere,
        Some(transform(&[
            scaling(0.3, 0.3, 0.3),
    ...
    let red_ball = world.scene.insert_object(
        Shape::Sphere,
    ...
    let blue_ball = world.scene.insert_object(
        Shape::Sphere,
        Some(transform(&[
            scaling(0.7, 0.7, 0.7),
    ...
    let green_ball = world.scene.insert_object(
        Shape::Sphere,
        Some(transform(&[
            scaling(0.5, 0.5, 0.5),
