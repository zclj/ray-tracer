...
fn main() {
    ...
    let _blue_glass_cube = world.push_cube(
        Some(transform(&[
            scaling(0.7, 0.7, 0.7),
    ...
    let _green_glass_cube = world.push_cube(
        Some(transform(&[
            scaling(0.5, 0.5, 0.5),
