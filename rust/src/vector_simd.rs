...
use std::arch::x86_64::{__m128, _mm_extract_ps, _mm_mul_ps, _mm_set_ps, _mm_dp_ps};
...
#[inline(always)]
pub fn simd_dot(lhs: &Vector, rhs: &Vector) -> f32 {
    // lhs.xyzw * rhs.xyzw
    unsafe{
...
mod tests {
    ...
    use crate::vector_simd::{simd_multiply, simd_dot, Vector};
