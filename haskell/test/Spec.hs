...
import ConesSpec
import GroupsSpec
import TrianglesSpec
import ObjFileParserSpec
...
rayTracerTests = testGroup "Ray Tracer Specs"
  ...
  , shapesTests, planesTests, patternTests, cubeTests, cylinderTests, coneTests, groupTests
  , triangleTests, objFileParserTests]
-- main :: IO ()
