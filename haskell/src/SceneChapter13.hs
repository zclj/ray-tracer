module SceneChapter13
  ( renderSceneChapter13
  ) where
...
renderSceneChapter13 =
  ...
  (World
   ...
   , redCylinder, blueGlassCylinder, greenGlassCylinder]
   lightSource)
